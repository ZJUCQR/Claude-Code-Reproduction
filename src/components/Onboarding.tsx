...
export function Onboarding({
  ...
  const apiKeyNeedingApproval = useMemo(() => {
    ...
    // Third-party Anthropic-compatible gateways legitimately use their own
    // ANTHROPIC_API_KEY values; don't route those through the custom-key
    // approval prompt intended for first-party Anthropic keys.
